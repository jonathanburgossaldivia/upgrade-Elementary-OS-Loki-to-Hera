...
sudo apt-get install sddm elementary-desktop elementary-tweaks indicator-application indicator-multiload pantheon-shell pantheon wingpanel plank lightdm-webkit-greeter  pantheon-terminal pantheon-xsession-settings contractor slingshot-launcher scratch elementary-theme elementary-icon-theme switchboard plank-theme-pantheon snap preload pantheon-file
